...
draw_rect(150,100,200,200,0,color=color_skin)#head

draw_rect(170,160,50,30,0,color=color_white)#eyes
draw_rect(280,160,50,30,0,color=color_white)#eyes

draw_rect(188,160,15,30,0,color=color_sky_blue)#eyes
draw_rect(298,160,15,30,0,color=color_sky_blue)#eyes

draw_rect(200,250,100,30,0,color=color_white)

draw_line([230,200],[230,220],color=color_black)
draw_line([230,220],[270,220],color=color_black)
...
draw_rect(190,350,130,170,0,color=color_emeraldgreen)#dress
draw_rect(140,350,50,50,0,color=color_emeraldgreen)#dress
draw_rect(320,350,50,50,0,color=color_emeraldgreen)#dress


draw_rect(150,100,30,50,0,color=color_brown)#hair
draw_rect(150,100,200,20,0,color=color_brown)#hair
draw_rect(320,100,30,50,0,color=color_brown)#hair
